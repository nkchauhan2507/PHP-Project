...
<div id="main">
    ...
    <span style="color:Green;font-size:15px;font-align:center;">{{session()->get('emptymsg')}}</span>
    <section class="home-section home-full-height bg-dark-30" style="max-height:721px;width:100%;" id="home" data-background="{{asset('assets')}}/images/urban.png">
            ...
            <div class="row multi-columns-row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <h3 class="features-title font-alt"><a href="/categorydata/{{$val->category_id}}" id="cname">{{$val->cname}}</a></h3>
                        {{--                        <p>{{$val->description}}</p>--}}
                    </div>
                </div>
                @endforeach
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                        <div class="alt-services-image align-center"><img src="{{asset('assets')}}/images/promo.png" alt="Feature Image"></div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="alt-features-item">
        ...
        <section class="module pb-0" id="works">
            ...
            <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid">
                <li class="work-item illustration webdesign"><a href="portfolio_single_featured_image1.html">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio1.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Corporate Identity</h3>
                            <div class="work-descr">Illustration</div>
                        </div></a></li>
                <li class="work-item marketing photography"><a href="portfolio_single_featured_image2.html">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio2.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Bag MockUp</h3>
                            <div class="work-descr">Marketing</div>
                        </div></a></li>
                <li class="work-item illustration photography"><a href="portfolio_single_featured_slider1.html">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio3.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Disk Cover</h3>
                            <div class="work-descr">Illustration</div>
                        </div></a></li>
                <li class="work-item marketing photography"><a href="portfolio_single_featured_slider2.htmll">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio4.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                ...
                <li class="work-item illustration webdesign"><a href="portfolio_single_featured_video1.html">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio5.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                ...
                <li class="work-item marketing webdesign"><a href="portfolio_single_featured_video2.html">
                        <div class="work-image"><img src="{{asset('assets')}}/images/portfolio/grid-portfolio6.jpg" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{asset('assets')}}/images/team-1.jpg" alt="Member Photo"/>
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{asset('assets')}}/images/team-2.jpg" alt="Member Photo"/>
                                <div class="team-detail">
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{asset('assets')}}/images/team-3.jpg" alt="Member Photo"/>
                                <div class="team-detail">
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{asset('assets')}}/images/team-4.jpg" alt="Member Photo"/>
                                <div class="team-detail">
            ...
            <div id="generic_price_table">
                <section>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            @foreach($mem as $val)
                            <form action="{{url('buymembership')}}/{{session()->get('user.u_id')}}" method="POST">
                            @csrf
                            <div class="col-md-4">
                                ...
                                <div class="generic_content clearfix">
                                    ...
                                    <div class="generic_head_price clearfix">
                                        ...
                                        <div class="generic_head_content clearfix">
                                            ...
                                            <div class="head">
                                                <span id="mtype">{{$val->type}}</span>
                                                <input type="hidden" name="mtype" value="{{$val->type}}">
                                            </div>
                                            <!--//HEAD END-->
                                ...
                                <span class="price">
                                    ...
                                    <span class="currency" name="mprice">{{$val->price}}</span>
                                    <input type="hidden" name="mprice" value="{{$val->price}}">
                                    {{--<span class="cent">.99</span>--}}
                                    <span class="month" name="mduration">/{{$val->duration}}-Month</span>
                                    <input type="hidden" name="mduration" value="{{$val->duration}}">
                                </span>
                                        </div>
                                        <!--//PRICE END-->
                                    </div>
                                    ...
                                    <div class="generic_feature_list">
                                        <ul>
                                            <li><span>Additional Offers</span></li>
                                    ...
                                    <div class="generic_price_btn clearfix">
                                        {{--<a id="mempayment" href="/membershippurchase">Purchase</a>--}}
                                        <button type="submit" id="mempayment" class="btn">Purchase</button>
