            ...
            <div class="container">
                <div class="row multi-columns-row">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="shop-item">
                            <div class="shop-item-image"><img src="{{asset('assets')}}/images/shop/product-7.jpg" alt="Accessories Pack"/>
                                {{--<div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Add To Cart</span></a></div>--}}
                            </div>
                            <h4 class="shop-item-title font-alt"><a href="/service/{{$val->sc_id}}">{{$val->scname}}</a></h4>
                        </div>
                    </div>
                    @endforeach
                </div>
